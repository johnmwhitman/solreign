...
namespace Content.Client.Stylesheets
{
    ...
    public sealed class StyleNano : StyleBase
    {
        ...
        public static readonly Color PanelDark = Color.FromHex("#111417");

        public static readonly Color NanoGold = Color.FromHex("#FFB000");
        public static readonly Color GoodGreenFore = Color.FromHex("#5BD94A");
        public static readonly Color ConcerningOrangeFore = Color.FromHex("#E07B39"); // stays distinct from NanoGold
        public static readonly Color DangerousRedFore = Color.FromHex("#BB3232");
        public static readonly Color DisabledFore = Color.FromHex("#5A5A5A");

        public static readonly Color ButtonColorDefault = Color.FromHex("#1A1D24");
        public static readonly Color ButtonColorDefaultRed = Color.FromHex("#D43B3B");
        public static readonly Color ButtonColorHovered = Color.FromHex("#2A2D34");
        public static readonly Color ButtonColorHoveredRed = Color.FromHex("#DF6B6B");
        public static readonly Color ButtonColorPressed = Color.FromHex("#5BD94A");
        public static readonly Color ButtonColorDisabled = Color.FromHex("#111417");
