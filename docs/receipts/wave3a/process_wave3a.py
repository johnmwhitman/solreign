#!/usr/bin/env python3
"""Post-process WAVE 3A generations -> 32x32 candidates + curation grids.
Reuses the pilot's process_sprite.py (channel-max anchor, flood-fill key, despeckle)
plus the batch-1/medium interior key sweep."""
import os, sys
...
BASE = os.path.join(os.path.dirname(os.path.abspath(__file__)), "wave3a-gen")
