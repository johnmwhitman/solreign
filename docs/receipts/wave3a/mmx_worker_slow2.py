#!/usr/bin/env python3
"""Serial, slow-paced retry worker: 15s between every single generation call, 6 tries
each with 15s backoff, to ride out sustained RPM contention from a concurrent lane."""
...
def gen(prompt, out_path, tries=8):
