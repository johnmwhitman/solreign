...
// SharedOreSiloSystem is a friend because the unified station-wide material pool needs direct
// field-level access to enforce its invariants: migrating a silo's stray local Storage into the
// pool, locking a pool's Can/InsertOnInteract/DropOnDeconstruct flags down, and bounding the
// pool's StorageLimit to what its contributing silos would have held (see SharedOreSiloSystem's
// GetStationMaterialPool and friends).
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState]
[Access(typeof(SharedMaterialStorageSystem), typeof(SharedOreSiloSystem))]
