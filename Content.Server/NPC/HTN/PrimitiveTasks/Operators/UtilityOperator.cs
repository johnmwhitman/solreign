...
public sealed partial class UtilityOperator : HTNOperator
{
    ...
    {
        // Solreign: leaked plan-job continuations can resume here after server teardown with a
        // stale EntityManager (HTNSystem.Shutdown now cancels the token). Bail before dereferencing.
