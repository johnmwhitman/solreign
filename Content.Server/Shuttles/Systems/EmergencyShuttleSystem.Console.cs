...
public sealed partial class EmergencyShuttleSystem
{
    ...
    /// <summary>
    /// Read-only telemetry: whether the round-scoped cancellation token for the eventual
    /// post-shuttle-departure EndRound callback remains armed. The token exists from round start;
    /// this does not imply that the callback timer has already been scheduled.
    /// </summary>
    public bool RoundEndCompletionTokenArmed => _roundEndCancelToken != null;
