...
namespace Content.IntegrationTests.Tests
{
    ...
    public sealed class PostMapInitTest : GameTest
    {
        ...
        private static readonly string[] Grids =
        {
            ...
            // Phase2 B1: Sublevel H and the Atrium (SolreignZoneGateSystem's lazily-loaded standalone
            // grids) — made permanent here after the Wave 10 verifier's temporary pass reverted this
            // same addition; CI should always load-test them going forward.
            SolreignZoneGateSystem.ZoneHellMapPath,
            SolreignZoneGateSystem.ZoneHeavenMapPath
        };
